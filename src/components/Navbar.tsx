    ...
    <nav className="border-b border-white/10 bg-vpl-card/50 backdrop-blur-md sticky top-0 z-40">
      <div className="container mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-primary/40 to-blue-600/40 border border-white/20 flex items-center justify-center text-[11px] font-bold text-white">
      ...
      {/* Mobile dropdown */}
      {mobileOpen && (
        <div className="sm:hidden border-t border-white/10 bg-vpl-card/95 backdrop-blur-md px-4 py-3 space-y-1 animate-fade-in">
