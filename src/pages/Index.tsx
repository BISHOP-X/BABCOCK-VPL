    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30">
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-border/50 bg-background/90 backdrop-blur-md">
        <div className="container mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
            <Button variant="ghost" size="icon" onClick={toggleTheme} className="h-9 w-9 text-muted-foreground hover:text-foreground hover:bg-muted">
              {theme === 'dark' ? <Sun className="h-4 w-4" /> : <Moon className="h-4 w-4" />}
            </Button>
            <Link to="/login">
              <Button variant="ghost" className="text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted h-9 px-3 sm:px-4">Sign In</Button>
            </Link>
            <Link to="/signup">
              <Button variant="default" className="bg-primary text-primary-foreground hover:bg-primary/90 font-semibold shadow-lg shadow-primary/20 text-sm h-9 px-3 sm:px-5">Get Started</Button>
            </Link>
          </div>
        </div>
      </nav>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src={heroImage} alt="Virtual Programming Lab" className="w-full h-full object-cover" />
        ...
        <div className="container relative z-10 px-4 sm:px-6 text-center">
          <div className="animate-fade-in space-y-6 sm:space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-sm sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed px-2">
              ...
              Cloud-based compilation, instant feedback, and lecturer grading &#8212; purpose-built for BUCODeL students and faculty.
            </p>
            <div className="flex flex-col xs:flex-row items-center justify-center gap-3 pt-2">
              <Link to="/signup" className="w-full xs:w-auto">
                <Button size="lg" className="w-full xs:w-auto h-12 sm:h-14 px-6 sm:px-8 text-base font-semibold bg-primary text-primary-foreground hover:bg-primary/90">Create Account</Button>
              </Link>
              <Link to="/login" className="w-full xs:w-auto">
                <Button size="lg" variant="outline" className="w-full xs:w-auto h-12 sm:h-14 px-6 sm:px-8 text-base glass-card border-border hover:bg-muted hover:text-foreground">Sign In</Button>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="container px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-muted-foreground text-sm sm:text-base max-w-xl mx-auto">
              BUCODeL VPL brings the full software development workflow into your browser &#8212; no installations required.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="group relative rounded-2xl overflow-hidden border border-border bg-card hover:-translate-y-1 transition-transform duration-300">
              <div className="aspect-[4/3] relative overflow-hidden">
                <img src={featureIde} alt="In-Browser IDE" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
              ...
              <div className="p-5 sm:p-6">
                ...
                <p className="text-muted-foreground text-sm sm:text-base">Monaco-powered editor with syntax highlighting, autocomplete, and support for 8 languages &#8212; Python, Java, C++, C, JavaScript, PHP, HTML &amp; CSS.</p>
              </div>
            </div>
            <div className="group relative rounded-2xl overflow-hidden border border-border bg-card hover:-translate-y-1 transition-transform duration-300">
              <div className="aspect-[4/3] relative overflow-hidden">
                <img src={featureCompile} alt="Cloud Compilation" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent" />
              </div>
              <div className="p-5 sm:p-6">
                ...
                <p className="text-muted-foreground text-sm sm:text-base">Run code instantly via cloud-based compilers. See output in real time, right in your browser &#8212; no software to install.</p>
              </div>
            </div>
            <div className="group relative rounded-2xl overflow-hidden border border-border bg-card sm:col-span-2 md:col-span-1 hover:-translate-y-1 transition-transform duration-300">
              <div className="aspect-[4/3] relative overflow-hidden">
                <img src={featureAnalytics} alt="Submission and Grading" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent" />
              </div>
              <div className="p-5 sm:p-6">
                ...
                <p className="text-muted-foreground text-sm sm:text-base">Students submit code per assignment. Lecturers review, grade, and leave feedback &#8212; all in one streamlined BUCODeL workflow.</p>
              </div>
            </div>
          </div>
        </div>
