        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="rounded-xl border border-white/10 overflow-hidden">
              ...
              <div className="bg-black/40 p-4 font-mono text-xs text-white/80 whitespace-pre-wrap min-h-[60px]">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-white/10 bg-vpl-card/50 p-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-white">{data.student.full_name}</p>
            ...
            <div className="rounded-xl border border-white/10 bg-vpl-card/50 p-4">
              ...
              {data.assignment.expected_output && (
                <div className="mt-3 p-2 rounded-lg bg-black/20 border border-white/5">
                  ...
                  <p className="text-xs font-mono text-white/70">{data.assignment.expected_output}</p>
                </div>
              )}
            </div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="mt-1.5 w-full rounded-md bg-white/5 border border-white/10 text-sm text-white px-3 py-2 resize-none focus:outline-none focus:ring-2 focus:ring-primary/50 disabled:opacity-60"
                  />
                </div>
